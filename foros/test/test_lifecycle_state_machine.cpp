...
TEST_F(TestLifecycleStateMachine, TestInactiveStateInit) {
  EXPECT_TRUE(
      state_machine_->get_current_state_type() == lifecycle::StateType::kInactive
  );
}
...
TEST_F(TestLifecycleStateMachine, TestInactiveStateActivateEvent) {
  ...
  EXPECT_TRUE(
      state_machine_->get_current_state_type() == lifecycle::StateType::kActive
  );
}
...
TEST_F(TestLifecycleStateMachine, TestInactiveStateStandbyEvent) {
  ...
  EXPECT_TRUE(
      state_machine_->get_current_state_type() == lifecycle::StateType::kStandby
  );
}
